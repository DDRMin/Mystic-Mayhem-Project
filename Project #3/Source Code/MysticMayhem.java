...
public class MysticMayhem {
    ...
    //this method is used to select the enemy before battle
    //also we can skip or choose the given player to battle with
    public static Player selectEnemy(Player user,List<Player> enemyList,Scanner scanner) {
        // Player 2
        try{
    ...
    public static void challengePlayer(Player user, Player enemy, Scanner scanner){
        ...
        player.setGoldCoins(user.getGoldCoins());
        player.setXP(user.getXP());
        player.setCharacterList(user.getCharacterList());
    ...
    private static void postMatch(Player player, Player enemy){
        System.out.println("*********************************************");
    ...
    public static void restart(Player user){
        user.setName(player.getName());
        user.setUserName(player.getUserName());
        user.setGoldCoins(player.getGoldCoins());
        user.setXP(player.getXP());
        user.setCharacterList(player.getCharacterList());
    }
